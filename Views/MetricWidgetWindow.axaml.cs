...
public partial class MetricWidgetWindow : OverlayWindow
{
    ...
    protected override void OnDataContextChanged(EventArgs e)
    {
        ...
        if (DataContext is MetricWidgetViewModel viewModel)
        {
    ...
    {
        if (DataContext is not MetricWidgetViewModel viewModel)
        {
            return;
        }
    ...
    {
        if (DataContext is MetricWidgetViewModel { IsCompact: true })
        {
