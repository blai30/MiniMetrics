...
public sealed class ElevationCoordinator
{
    private readonly IElevation _elevation;
    private readonly IDriverProbe _driverProbe;

    public ElevationCoordinator(IElevation elevation, IDriverProbe driverProbe)
    {
        _elevation = elevation;
        _driverProbe = driverProbe;
    }
    ...
    public bool ShouldRelaunch(IReadOnlyDictionary<string, bool> visibility) =>
        ElevationGate.ShouldRelaunch(visibility, _elevation.IsElevated(), _driverProbe.IsInstalled());
    ...
    public bool NeedsDriverInstallPrompt(IReadOnlyDictionary<string, bool> visibility) =>
        RequiresElevation(visibility) && !_driverProbe.IsInstalled();
    ...
    public MetricEnableAction DecideMetricEnable(string key, bool visible)
    {
        ...
        {
            return MetricEnableAction.None;
        }
        ...
        return _driverProbe.IsInstalled()
    ...
    public bool RelaunchElevated(string exePath) => _elevation.RelaunchElevated(exePath);
}
